...
image = cv2.imread('plate12.jpg',cv2.IMREAD_UNCHANGED)
...
print("--------------------------")
#converting string to alphanumeric string(containing only numbers and alphabetes)
alphanumeric =""
